...
import craftImg from "../assets/images/about_craft_design_1784522154639.jpg";
...
export default function AboutPage({ onShopClick }: AboutPageProps) {
  ...
  return (
    <div className="bg-white min-h-screen font-sans">
      ...
      <section className="relative overflow-hidden bg-[#F3F5FC] py-10 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 border-b border-slate-200/60">
        
        {/* Soft solid decorative ambient accents */}
        <div className="absolute top-1/2 left-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-brand-purple/5 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/2 pointer-events-none" />
        <div className="absolute top-1/3 right-10 w-60 sm:w-80 h-60 sm:h-80 bg-brand-purple/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-16 items-center relative z-10">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight md:leading-[1.1] font-sans">
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-3 pt-1 sm:pt-2 max-w-lg">
              ...
              <div className="bg-white p-3 rounded-xl border border-slate-200/80 shadow-xs xs:col-span-2 sm:col-span-1 flex items-center space-x-2.5">
            ...
            <div className="pt-2 sm:pt-3">
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={onShopClick}
                className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 bg-brand-purple hover:bg-brand-purple-dark text-white font-semibold px-6 sm:px-7 py-3.5 rounded-xl shadow-lg shadow-brand-purple/20 transition-all cursor-pointer group text-[14px]"
              >
          ...
          <motion.div
            ...
            id="about-hero-image"
          >
            <div className="relative w-full max-w-[300px] sm:max-w-[360px] mx-auto">
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 lg:mb-20">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 tracking-tight mt-3 sm:mt-4">
              Behind the Curation
            </h2>
                ...
                >
                  ...
                  <div className={`lg:col-span-6 space-y-3 sm:space-y-4 ${
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-brand-purple font-mono font-black text-base sm:text-lg">
                        {milestone.step}
                      </span>
                      <span className="text-[10px] sm:text-[11px] font-bold uppercase text-slate-400 tracking-widest">
                        {milestone.badge}
                      </span>
                    </div>

                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-extrabold text-slate-900 tracking-tight font-sans">
                      {milestone.title}
                    </h3>
                    
                    <p className="text-xs sm:text-[14px] lg:text-[15px] text-slate-500 leading-relaxed font-normal">
                      {milestone.description}
                    </p>

                    <div className="pt-1 sm:pt-2">
                      <span className="inline-flex items-center space-x-1.5 bg-slate-100 text-slate-700 font-sans text-[10px] sm:text-[11px] font-bold py-1 px-3 rounded-full">
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight mt-3 sm:mt-4">
              What We Standardize
            </h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6 lg:gap-8">
            ...
            {/* Pillar 1 */}
            <div className="bg-white border border-slate-200/60 rounded-2xl p-6 sm:p-8 shadow-xs flex flex-col justify-between">
              <div className="space-y-3 sm:space-y-4">
                <div className="h-10 w-10 rounded-xl bg-brand-purple-light text-brand-purple flex items-center justify-center">
                  <Shield className="h-5 w-5" />
                </div>
                <h3 className="text-base sm:text-lg font-bold text-slate-900">Secure & Protected</h3>
            ...
            <div className="bg-white border border-slate-200/60 rounded-2xl p-6 sm:p-8 shadow-xs flex flex-col justify-between">
              <div className="space-y-3 sm:space-y-4">
                ...
                <h3 className="text-base sm:text-lg font-bold text-slate-900">Curated Explorer</h3>
                <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
            ...
            {/* Pillar 3 */}
            <div className="bg-white border border-slate-200/60 rounded-2xl p-6 sm:p-8 shadow-xs flex flex-col justify-between sm:col-span-2 md:col-span-1">
              <div className="space-y-3 sm:space-y-4">
                <div className="h-10 w-10 rounded-xl bg-brand-purple-light text-brand-purple flex items-center justify-center">
                  <Clock className="h-5 w-5" />
                </div>
                <h3 className="text-base sm:text-lg font-bold text-slate-900">Support Under 24h</h3>
                <p className="text-xs sm:text-sm text-slate-500 leading-relaxed">
      ...
      <section className="py-14 sm:py-20 lg:py-24 bg-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-slate-900 text-white rounded-3xl p-6 sm:p-10 md:p-14 text-center max-w-4xl mx-auto shadow-lg relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-xl mx-auto space-y-4 sm:space-y-6">
              ...
              <h3 className="text-xl sm:text-3xl md:text-4xl font-extrabold tracking-tight text-white leading-tight font-sans">
              ...
              <div className="pt-2 flex justify-center">
                <button
                  onClick={onShopClick}
                  className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 bg-brand-purple hover:bg-brand-purple-dark text-white font-semibold px-6 sm:px-8 py-3.5 sm:py-4 rounded-xl shadow-lg shadow-brand-purple/20 hover:shadow-brand-purple/30 transition-all cursor-pointer group text-[14px] sm:text-[15px]"
                >
                  <span>EXPLORE OUR PRODUCTS</span>
                  <ArrowRight className="h-4.5 sm:h-5 w-4.5 sm:w-5 group-hover:translate-x-1 transition-transform" />
                </button>
              </div>
            </div>
          </div>
